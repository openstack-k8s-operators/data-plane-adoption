...
//kgilliga: I combined the "Extend the monitoring label to the target nodes" section with "Migrating the monitoring stack to the target nodes". Is this structure okay?
