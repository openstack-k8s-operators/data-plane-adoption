...
The {image_service} adoption follows the same pattern as the {identity_service_first_ref} adoption. For more information, see xref:adopting-the-identity-service_adopt-control-plane[Adopting the {identity_service}]
endif::[]
