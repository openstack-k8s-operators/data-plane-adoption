...
Before you migrate your {Ceph} cluster to the {rhos_long_noacro} {rhos_curr_ver} environment, complete the following tasks in your {rhos_prev_long} {rhos_prev_ver} environment:
