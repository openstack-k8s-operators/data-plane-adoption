...
{rhos_prev_long} version, since configuration options may have been deprecated,
...
it or doing it quick and dirty. There is no difference in how {block_storage} will
