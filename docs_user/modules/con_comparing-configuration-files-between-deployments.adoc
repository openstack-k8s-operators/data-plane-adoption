...
Then configure /etc/os-diff/os-diff.cfg and /etc/os-diff/ssh.config file according to your environment:

In order to allow os-diff to connect to your clouds and pull files from the services you describe in the config.yaml
file you need to properly set the option in the os-diff.cfg:
...
Configure or generate ssh.config file from inventory or hosts file
