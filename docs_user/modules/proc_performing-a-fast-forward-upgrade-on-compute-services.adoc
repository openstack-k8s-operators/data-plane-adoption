...
[NOTE]
After the data plane adoption, the hosts continue to run RHEL
{rhel_prev_ver}. In order to take advantage of RHEL {rhel_curr_ver},
perform a minor update procedure after finishing the adoption
procedure.
