...
* Back up the configuration files from the {OpenStackShort} services and {OpenStackPreviousInstaller} on your file system. You can use the backups later to compare against the adopted {rhos_long} service configuration.
