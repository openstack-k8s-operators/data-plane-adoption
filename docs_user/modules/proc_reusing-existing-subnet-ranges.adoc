...
If your existing subnets do not have enough IP addresses in the existing subnet ranges for the new control plane services, you must create new subnet ranges. For more information, see xref:proc_using-new-subnet-ranges.adoc#using-new-subnet-ranges_{context}[Using new subnet ranges].
