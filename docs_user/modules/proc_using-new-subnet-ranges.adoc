...
[NOTE]
If you are using IPv6, you can reuse existing subnet ranges in most cases. For more information about existing subnet ranges, see xref:proc_reusing-existing-subnet-ranges.adoc#reusing-existing-subnet-ranges_{context}[Reusing existing subnet ranges].
