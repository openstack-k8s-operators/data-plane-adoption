...
//kgilliga: Is this a step? Can we rewrite it to something like: "Check the status of the Ceph cluster and export the MDS metadata"? Should this "cardinality matrix" article be available only downstream?
+
----
