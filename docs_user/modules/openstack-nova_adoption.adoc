...
//Check xref contexts.
//In Post-checks, reinstate the xref in the following text:Compare the following outputs with the topology specific configuration
//in xref:pulling-the-openstack-configuration_{context}[Pulling the OpenStack configuration].
...
//xref:pulling-the-openstack-configuration_{context}[Pulling the OpenStack configuration].kgilliga: Commented out for dev preview 3.
