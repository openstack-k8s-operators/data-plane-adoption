...
* You have reviewed the adoption-specific networking requirements. For more information, see xref:configuring-network-for-RHOSO-deployment_{context}[Configuring the network for the RHOSO deployment].
