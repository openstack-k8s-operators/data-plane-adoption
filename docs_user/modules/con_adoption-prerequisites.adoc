...
* Review the xref:con_adoption-limitations.adoc#adoption-limitations_{context}[Adoption limitations].
...
* Install the `systemd-container` package on your Compute hosts. For more information, see xref:proc_installing-the-systemd-container-package-on-compute-hosts.adoc#installing-the-systemd-container-package-on-compute-hosts_{context}[Installing the `systemd-container` package on Compute hosts].
