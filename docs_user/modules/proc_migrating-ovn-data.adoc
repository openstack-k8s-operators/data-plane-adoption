...
[IMPORTANT]
In case your podified control plane has a different subnet than the tripleo deployment, you need to add an iptable rule to allow your traffic from the podified subnet.
