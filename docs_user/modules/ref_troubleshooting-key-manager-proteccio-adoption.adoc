...
*Symptoms*:
----
Failed to pull image "quay.io/rh_ee_mharley/openstack-barbican-api:current-podified-proteccio": rpc error
...
+
----
$ podman pull quay.io/rh_ee_mharley/openstack-barbican-api:current-podified-proteccio
----
