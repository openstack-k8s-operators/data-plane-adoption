...
* Stop the {OpenStackShort} services. For more information, see xref:proc_stopping-openstack-services.adoc#stopping-openstack-services_{context}[Stopping {rhos_prev_long} services].
