 ...
 ** Required services specific topology. For more information, see xref:proc_retrieving-topology-specific-service-configuration_adopt-control-plane[Retrieving topology-specific service configuration].
...
For more information, see xref:proc_retrieving-topology-specific-service-configuration_adopt-control-plane[Retrieving topology-specific service configuration].
