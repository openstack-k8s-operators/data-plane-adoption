...
----
//The copy button only copies the "oc extract" line in the code block above. Are these supposed to be 3 separate commands?
...
$CONTROLLER1_SSH "systemctl restart tripleo_swift_*"
----
//The copy button only copies the "oc extract" line.
+
