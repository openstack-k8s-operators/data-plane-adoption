...
`<dcn2-hci-0 IP>`, `<dcn2-hci-0 IP>`, `<dcn2-hci-0 IP>`::
...
* The etcd service, `tripleo_etcd.service`, is used as a distributed lock manager for the {block_storage} volume service running in active/active mode on edge sites.
====
