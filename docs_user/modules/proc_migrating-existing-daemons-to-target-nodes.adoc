...
nodes.
//kgilliga: Note to self: This intro will be rewritten for GA.

.Procedure

. Add the monitoring label to all the {CephCluster} (or ComputeHCI) nodes in the cluster:
//kgilliga: Please verify that my description of the step is accurate.
+
----
...
//kgilliga: Same question here: What does "the procedure described above" refer to?
