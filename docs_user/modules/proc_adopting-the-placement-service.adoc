...
* You adopt the {identity_service_first_ref} to the {rhos_long} the xref:adopting-the-identity-service_adopt-control-plane[Adopting the Identity service].
* You must deploy the Memcached operator. For more information, see xref:deploying-backend-services_migrating-databases[Deploying back-end services].
