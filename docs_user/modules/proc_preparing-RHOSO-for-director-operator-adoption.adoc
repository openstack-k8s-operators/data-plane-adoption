...
----
[NOTE]
 This step can also be achieved by following the Openstack Service On Openshift procedure, see link:https://docs.redhat.com/en/documentation/red_hat_openstack_services_on_openshift/18.0/html-single/deploying_red_hat_openstack_services_on_openshift/index#assembly_installing-and-preparing-the-Operators[Installing the Openstack Operator].
