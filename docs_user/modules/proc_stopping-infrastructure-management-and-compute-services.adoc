...
CONTROLLER1_SSH="ssh -i ~/install_yamls/out/edpm/ansibleee-ssh-key-id_rsa tripleo-admin@<controller-1 IP>"
# ...
endif::[]
ifeval::["{build}" == "downstream"]
CONTROLLER1_SSH="ssh -i <path_to_SSH_key> tripleo-admin@<controller-1 IP>"
# ...
endif::[]
# ...
ifeval::["{build}" != "downstream"]
...
----
+
** `CONTROLLER<X>_SSH` defines the SSH connection details for all Controller nodes, including cell Controller nodes, of the source {OpenStackPreviousInstaller} cloud.
ifeval::["{build}" == "downstream"]
