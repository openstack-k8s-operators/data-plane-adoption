...
Make sure you have the correct rights to edit the file example:
...
This command will pull all the configuration files describe into the /etc/os-diff/config.yaml file.
